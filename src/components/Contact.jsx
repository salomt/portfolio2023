...
const socialBtn =
  "flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-rose-300/35 bg-white/10 text-rose-100 transition hover:border-rose-300/55 hover:bg-rose-300/15 hover:text-white"
      ...
      <div className="mx-auto max-w-[1240px]">
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-stretch lg:gap-12">
          <div className="flex flex-col rounded-xl border border-rose-300/20 bg-black/15 p-6 backdrop-blur-sm sm:p-8 lg:min-h-0 lg:h-full">
            <p className="leading-relaxed text-[#eceff2]/90">
              I am available for new projects and gigs — connect using the links below or send a message.
            </p>
            <div className="mt-auto flex flex-wrap gap-3 pt-8">
              ...
              <a
                href="https://open.spotify.com/artist/4Zu0QLKCCz02GjpdBvSSi9?si=xJ7Uxx7FTGGNMfwKrYTrIg"
                target="_blank"
